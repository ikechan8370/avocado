...
mod tests {
    ...
    use crate::utils::image::{
        draw_filled_rect_with_circle_corner, is_emoji, overlay_image, overlay_image_from_url,
    ...
    async fn it_works() {
        ...
        overlay_image_from_url(
            (x, y),
            &mut image,
            "https://q1.qlogo.cn/g?b=qq&nk=450960006&s=0".to_string(),
        ...
        render_text_with_different_fonts(
            &mut image,
            black,
            net_start_x as i32 + (half_content_width / 2) as i32,
            network_text_top,
            network_scale,
            down_text.to_string(),
            None,
        ...
        let (content_text_width, content_text_height) =
            get_text_size(&font, uptime_text, uptime_scale);
        let uptime_text_left =
            uptime_content_left + (half_content_width - content_text_width as u32) / 2;
        ...
        let foot_start =
            padding_left_right + (width - 2 * padding_left_right - foot_width as u32) / 2;
        render_text_with_different_fonts(
            &mut image,
            grey,
            foot_start as i32,
